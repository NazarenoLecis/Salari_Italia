...
EUROSTAT_REQUESTS = (
    {
        "name": "ses_distribution_by_sex",
        "dataset_id": "earn_ses_hourly",
        "description": "Decile 1, mediana e decile 9 delle retribuzioni orarie lorde per sesso.",
        "filters": {
            "nace_r2": "B-S_X_O",
            "isco08": "TOTAL",
            "worktime": "TOTAL",
    ...
    },
    {
        "name": "ses_by_age",
        "dataset_id": "earn_ses_hourly",
        "description": "Retribuzione oraria mediana per classe di età e sesso.",
        "filters": {
            "nace_r2": "B-S_X_O",
            "isco08": "TOTAL",
            "worktime": "TOTAL",
    ...
    },
    {
        ...
        "dataset_id": "earn_ses_hourly",
        "description": "Retribuzione oraria mediana per professione ISCO-08 e sesso.",
        "filters": {
            "nace_r2": "B-S_X_O",
            "worktime": "TOTAL",
            "age": "TOTAL",
    ...
    },
    {
        "name": "ses_by_sector",
        "dataset_id": "earn_ses_hourly",
        "description": "Retribuzione oraria mediana per settore NACE Rev. 2 e sesso.",
        "filters": {
            "isco08": "TOTAL",
            "worktime": "TOTAL",
            "age": "TOTAL",
    ...
    },
    {
        ...
        "dataset_id": "earn_ses_hourly",
        "description": "Retribuzione oraria mediana per regime di orario e sesso.",
        "filters": {
            "nace_r2": "B-S_X_O",
            "isco08": "TOTAL",
            "age": "TOTAL",
